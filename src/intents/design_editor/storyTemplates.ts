...
export const TEMPLATES: StoryTemplate[] = [
  ...
  },
  {
    ...
    elements: [
      { kind: "bg" },
      { kind: "accent_bar", top: 200, left: 70, width: 940, height: 350, radius: 36 },
      { kind: "headline", top: 240, left: 110, width: 860, fontSize: 108 },
      { kind: "subhead", top: 692.8, left: 110, width: 860, fontSize: 48 },
      { kind: "cta_pill", top: 960, left: 380, width: 320, height: 96, radius: 48 },
      { kind: "cta_text", top: 988, left: 380, width: 320, fontSize: 38 },
      { kind: "footer", top: 1466, left: 110, width: 860, fontSize: 34 },
    ],
  },
  {
    id: "t_prem_01",
    ...
    elements: [
      ...
      { kind: "headline", top: 275, left: 140, width: 800, fontSize: 78 },
      { kind: "subhead", top: 680, left: 160, width: 760, fontSize: 40 },
      { kind: "cta_pill", top: 936, left: 380, width: 320, height: 84, radius: 42 },
      { kind: "cta_text", top: 960, left: 380, width: 320, fontSize: 34 },
      { kind: "footer", top: 1332, left: 140, width: 800, fontSize: 30 },
    ],
  },
];
